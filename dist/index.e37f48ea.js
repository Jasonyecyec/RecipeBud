...
var _searchViewMobileJsDefault = parcelHelpers.interopDefault(_searchViewMobileJs);
var _navbarMobileActionViewJs = require("./views/navbarMobileActionView.js");
var _navbarMobileActionViewJsDefault = parcelHelpers.interopDefault(_navbarMobileActionViewJs);
var _resultsViewJs = require("./views/resultsView.js");
var _resultsViewJsDefault = parcelHelpers.interopDefault(_resultsViewJs);
var _bookmarksViewJs = require("./views/bookmarksView.js");
var _bookmarksViewJsDefault = parcelHelpers.interopDefault(_bookmarksViewJs);
var _addRecipeMobileViewJs = require("./views/addRecipeMobileView.js");
...
const navigationMenuContainer = document.querySelector(".navigation-menu-container");
const shoppingListDesktopSection = document.querySelector(".shopping-list-desktop-section");
...
const recipeMobileScrollContainer = document.querySelector(".recipe-mobile-scroll-container");
const bookmarkAction = document.querySelector(".bookmark-list-container");
const bookmarkDesktopAction = document.querySelector("#bookmark-hover-container");
...
const controlSearchResults = async function() {
    try {
        //show container
        (0, _resultsViewJsDefault.default).showParent();
        //render spinner
        (0, _resultsViewJsDefault.default).renderSpinner();
        //if object is empty render message
        if ((0, _lodashDefault.default).isEmpty(_modelJs.state.recipe)) (0, _recipeViewJsDefault.default).renderMessage("Click to see the recipe </br> or ingredients.");
        //get search input
        const query = (0, _searchViewMobileJsDefault.default).getQuery();
        await _modelJs.loadSearchResults(query);
        (0, _resultsViewJsDefault.default).render(_modelJs.state.search.results);
        //call scroll observer
        (0, _resultsViewJsDefault.default).observer();
    } catch (error) {
        console.log(error);
...
const navbarAction = function() {
    //guard clause
    if (!(0, _navbarMobileActionViewJsDefault.default).getTargetClass()) return;
    //
    (0, _navbarMobileActionViewJsDefault.default).showNavabarAction();
};
...
const controlShoppingListMobile = function() {
    if (!_modelJs.state.recipe.addedToList) _modelJs.addShoppingList(_modelJs.state.recipe);
    else _modelJs.deleteShoppingList(_modelJs.state.recipe.id);
    //update recipe view
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe);
    //render bookmarks
...
const shoppingListMobileAction = function(dataId) {
    ...
    _modelJs.deleteShoppingList(dataId);
...
const bookmarkMobileAction = function(dataId) {
    //delete in bookmark
    _modelJs.deleteBookmark(dataId);
    //render bookmarks
    (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
...
const controlAddRecipe = async function(data) {
    try {
        const emptyData = _modelJs.validateUploadData(data);
        const invalidURL = _modelJs.validateURL(data);
        const wrongFormatIng = _modelJs.validateUploadIngredients(data);
        (0, _addRecipeMobileViewJsDefault.default).renderInputBorderData();
        if (!(0, _lodashDefault.default).isEmpty(emptyData)) {
            (0, _addRecipeMobileViewJsDefault.default).renderErrorUploadData(emptyData);
            return;
        }
        if (!(0, _lodashDefault.default).isEmpty(invalidURL)) {
            (0, _addRecipeMobileViewJsDefault.default).renderErrorURL(invalidURL);
            (0, _addRecipeMobileViewJsDefault.default).showMessage("Invalid URL");
            return;
        }
        (0, _addRecipeMobileViewJsDefault.default).renderInputBorderIngredients();
        if (!(0, _lodashDefault.default).isEmpty(wrongFormatIng)) (0, _addRecipeMobileViewJsDefault.default).renderErrorFormatIng(wrongFormatIng);
        //render spinner
        (0, _addRecipeMobileViewJsDefault.default).renderSpinner();
        //upload recipe
        await _modelJs.uploadRecipe(data);
        //remove spinner then show message
        (0, _addRecipeMobileViewJsDefault.default).showMessage("Uploaded Succesfully!");
        //render recipe
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
        //close form
        (0, _addRecipeMobileViewJsDefault.default).closeAddRecipeForm();
        //render bookmarks
        (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
        //change ID in URL
        ...
        console.log(error);
        (0, _addRecipeMobileViewJsDefault.default).showMessage(error);
    }
};
const controlAddIngredients = function(control) {
    _modelJs.controlIngredientCount(control);
    if (_modelJs.state.ingredientsCount >= 7) (0, _addRecipeMobileViewJsDefault.default).renderDeleteIngredientBtn("show");
    if (_modelJs.state.ingredientsCount === 6) (0, _addRecipeMobileViewJsDefault.default).renderDeleteIngredientBtn("hide");
    if (control === "add") (0, _addRecipeMobileViewJsDefault.default).renderAddIngredients(_modelJs.state.ingredientsCount);
    if (control === "delete") (0, _addRecipeMobileViewJsDefault.default).renderDeleteIngredients();
};
const init = function() {
    (0, _bookmarksViewJsDefault.default).addHandlerRender(bookmarksRender);
    (0, _shoppingListMobileViewJsDefault.default).addHandlerRender(shoppingListMobileRender);
    (0, _recipeViewJsDefault.default).addHandlerRender(controlRecipes);
    (0, _searchViewMobileJsDefault.default).addHandlerSearch(controlSearchResults);
    (0, _navbarMobileActionViewJsDefault.default).addHandlerNavbarAction(navbarAction);
    (0, _recipeViewJsDefault.default).addHandlerUpdateServings(controlServings);
    (0, _recipeViewJsDefault.default).addHandlerBookmark(controlBookmark);
    (0, _recipeViewJsDefault.default).addHandlerShoppingList(controlShoppingListMobile);
    (0, _bookmarksViewJsDefault.default).addHandlerBookmarkMobileAction(bookmarkMobileAction);
    (0, _shoppingListMobileViewJsDefault.default).addHandlerShoppingListMobileAction(shoppingListMobileAction);
    (0, _addRecipeMobileViewJsDefault.default).addHandlerUpload(controlAddRecipe);
    (0, _addRecipeMobileViewJsDefault.default).addHandlerControlIngredients(controlAddIngredients);
};
init();
// //add hide css
...
navigationMenuContainer.addEventListener("click", function(e) {
    if (e.target.className.includes("shopping-list-menu")) {
        ...
        removeHide(shoppingListDesktopSection.firstElementChild, "hide-shopping-list");
...
parcelHelpers.export(exports, "controlIngredientCount", ()=>controlIngredientCount);
parcelHelpers.export(exports, "loadSearchResults", ()=>loadSearchResults);
parcelHelpers.export(exports, "updateServings", ()=>updateServings);
parcelHelpers.export(exports, "addShoppingList", ()=>addShoppingList);
parcelHelpers.export(exports, "deleteShoppingList", ()=>deleteShoppingList);
parcelHelpers.export(exports, "addBookmark", ()=>addBookmark);
parcelHelpers.export(exports, "deleteBookmark", ()=>deleteBookmark);
parcelHelpers.export(exports, "validateURL", ()=>validateURL);
parcelHelpers.export(exports, "validateUploadData", ()=>validateUploadData);
parcelHelpers.export(exports, "validateUploadIngredients", ()=>validateUploadIngredients);
...
const state = {
    ...
    bookmarks: [],
    shoppingList: [],
    ingredientsCount: (0, _configJs.ING_COUNT)
};
...
const loadRecipe = async function(recipeId) {
    try {
        const data = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL)}/${recipeId}?key=${(0, _configJs.API_KEY)}`);
...
const controlIngredientCount = function(control) {
    if (control === "add") state.ingredientsCount++;
    if (control === "delete" && state.ingredientsCount > 6) state.ingredientsCount--;
};
const loadSearchResults = async function(recipeName) {
    try {
        state.search.query = recipeName;
        const { data  } = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL)}?search=${recipeName}&key=${(0, _configJs.API_KEY)}`);
...
const addShoppingList = function(recipe) {
    //Add shopping list
    state.shoppingList.push(recipe);
    //Mark current recipe as addedToList
    if (recipe.id === state.recipe.id) state.recipe.addedToList = true;
    persistShoppingList();
};
const deleteShoppingList = function(id) {
    //delete shopping list
    const index = state.shoppingList.findIndex((el)=>el.id === id);
    state.shoppingList.splice(index, 1);
    //Mark current recipe as NOT on added to list
    if (id === state.recipe.id) state.recipe.addedToList = false;
    persistShoppingList();
};
...
const validateURL = function(data) {
    const invalidURL = Object.entries(data).slice(1, 3).filter(checkURL);
    return invalidURL;
};
const validateUploadData = function(data) {
    //return empty input data
    const uploadData = Object.entries(data).slice(0, 6).filter((entry)=>entry[1] === "").map((entry)=>entry[0]);
    return uploadData;
};
const validateUploadIngredients = function(data) {
    //return wrong format ingredients
    const uploadIngredients = Object.entries(data).filter((entry)=>{
        return entry[0].startsWith("ing") && entry[1] !== "";
    }).filter((ing)=>{
        const ingArr = ing[1].replaceAll(" ", "").split(",");
        if (ingArr.length !== 3) return ing[0];
    }).map((entry)=>entry[0]);
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>{
            ...
            if (ingArr.length !== 3) throw "Wrong ingredient format!, Please use the correct format.";
...
parcelHelpers.export(exports, "ING_COUNT", ()=>ING_COUNT);
...
},{}]},["fA0o9","aenu9"], "aenu9", "parcelRequire3a79")
